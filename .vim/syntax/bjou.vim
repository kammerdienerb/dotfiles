...
syn keyword     bjouKeywords        const macro proc __no_mangle__ extern type extends abstract this ref enum print new mut delete as import module using sizeof bshl bshr band bor bxor bneg foobar
