...
syn keyword     bjouKeywords        const macro proc __no_mangle__ __inline__ extern externvar type extends abstract this This ref enum print new delete as import module using sizeof bshl bshr band bor bxor bneg
